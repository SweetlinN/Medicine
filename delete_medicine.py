...
def Delete():
    ...
    if cursor.rowcount>0:
        ...
        msg.showinfo("Error Message","message couldn't be deleted",icon='warning')
    cursor.close()
    conn.commit()
...
################
ViewFrame = Frame(window,width=400)
ViewFrame.pack(side=TOP)

###############################
tv = ttk.Treeview(ViewFrame,columns=('MedicineName','MedicineID','Brand','ChemicalComponent','MFG_Date','EXP_Date','price'))
